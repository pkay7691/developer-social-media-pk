    ...
    return (
        ...
        <Box sx={{ flexGrow: 1 }}>
            <Grid container spacing={2} columns={10} value={Tabs} height='100vh' >
                ...
                <Grid item xs={3}>
                    <Box sx={{ bgcolor: "white", height: "100vh", borderRadius:"10px", padding:'10px' }}>
                ...
                <Grid item xs={7} maxHeight="100vh" overflow='scroll'>
                    ...
                    <Box id='chabox' sx={{ bgcolor: "white", border: 'solid', borderRadius:'10px', height: '80vh', width: '70%', position:'absolute', overflow:'scroll'}}>
